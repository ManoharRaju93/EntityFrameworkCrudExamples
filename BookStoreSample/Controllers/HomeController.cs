...
namespace IActionResultExample.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index(int? bookid, [FromRoute] bool? isloggedin,BookModel book)
        {
            ...
            return Content($"Book id: {book.BookId} Book Author is: {book.Author}", "text/plain");
        }
    }
}